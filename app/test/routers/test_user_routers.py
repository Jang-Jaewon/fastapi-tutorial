...
def test_register_user_route(db_session):
    body = {"username": "jaewon", "password": "pass#"}
...
def test_register_user_route_user_already_exists(user_on_db):
    body = {"username": user_on_db.username, "password": "pass#"}
...
def test_user_login_route_invalid_username(user_on_db):
    body = {"username": "Invalid", "password": "pass#"}
...
def test_user_login_route_invalid_password(user_on_db):
    body = {"username": user_on_db.username, "password": "invalid"}
